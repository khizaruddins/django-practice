...
def create_project():
    ...
    if check_dir_exists(projectName) != True:
        ...
        print(projectName + ' has already been created')
        create_project()
...
def create_app():
    ...
    if check_dir_exists(appName) != True:
        ...
        print(appName + ' has already been created')
...
# def test():
#     appname = getInput('appname')
#     dirCreation = 'mkdir {}'.format(appname)
#     check_for_dir(appname)
...
# def cd_front(value):
#     print('current dir.. \n' + os.getcwd() + '/' + value)
#     return run_cmd('cd {}'.format(value))
...
{% endblock %}"""
    ...
    print("Templating files created..\n")
...
if __name__ == '__main__':
    create_project()  # done
    create_app()  # done
    config_settings()  # done
    set_folder_structure()  # done
    create_template_files()  # done
    edit_project_urls()  # done
    create_app_urls()  # done
    edit_app_views()  # done
    migrate_models()  # done
    make_migration_models()  # done
    runserver()  # done
